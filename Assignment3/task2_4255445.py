...
def plot_xz_projection(data, labels):
    ...
    # TO DO: Implement the function to plot the XY projection of the dataset
    plt.figure()
    scatter = plt.scatter(data[:, 0], data[:, 2], c=labels, cmap='viridis', s=50)
    plt.xlabel('Feature 1')
...
def plot_yz_projection(data, labels):
    ...
    # TO DO: Implement the function to plot the XY projection of the dataset
    plt.figure()
    scatter = plt.scatter(data[:, 1], data[:, 2], c=labels, cmap='viridis', s=50)
...
def plot_pca_results(data_pca, labels):
    ...
    plt.figure()
    scatter = plt.scatter(data_pca[:, 0], data_pca[:, 1], c=labels, cmap='viridis', s=50)
